                    ...
                    <div class="container-menu">
                        <div class="content-menu">
                            <ul>
                                ...
                                <li>
                                    {{-- <a href="{{ route('sistemasAdministrativos') }}" class="{{ (\Request::route()->getName() == 'sistemasAdministrativos') ? 'active' : '' }}"><strong>Sistemas</strong> Administrativos
                                ...
                                {{-- <li>
                                    <a href="https://grupodmi.freshservice.com" class="" target="_blank">Sistema de Tickets y Servicios
                                        <button type="button" class="btn btn-secondary tooltip-menu d-none" data-toggle="tooltip" title="En esta sección encontrarás el enlace hacia el Sistema de Tickets y Servicios.">
                                            <i class="fas fa-info-circle"></i>
                                        </button>
                                    </a>
                                </li> --}}
