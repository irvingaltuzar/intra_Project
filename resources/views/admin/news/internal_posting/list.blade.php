...
@section( 'content')
    ...
    @include('admin.news.internal_posting.addModal')
    @include('admin.news.internal_posting.modalUserList')
    @include('admin.news.internal_posting.editModal')
    @include('admin.news.internal_posting.modalUserListEdit')
    @include('admin.news.internal_posting.viewModal')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/news/internal_posting.js')}}"></script>
