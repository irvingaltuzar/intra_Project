      ...
      <div class="modal-content">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-9">
                        <h4><i class="fas fa-eye"></i> Posteo Interno</h4>
                    </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="form-floating col-sm-12 col-md-3">
                                <input type="date" class="form-control" id="txt_publication_date_view"
                                    placeholder="Fecha de publicación" required disabled>
                                <label for="txt_publication_date_view">Fecha de publicación <span class="input-required">*</span></label>
                            </div>
                            <div class="form-floating col-sm-12 col-md-3">
