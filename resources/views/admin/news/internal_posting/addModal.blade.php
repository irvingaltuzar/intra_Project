        ...
        <div class="modal-content">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-9">
                            <h4><i class="fas fa-plus"></i> Posteo Interno</h4>
                        </div>
                    ...
                    <div class="container">
                        <div class="row mt-3" id="data_form_add">
                            <div class="row mb-2">
                                ...
                                <div class="form-floating col-sm-12 col-md-3">
                                    <input type="date" class="form-control" id="txt_publication_date"
                                        placeholder="Fecha de publicación" required>
                                    <label for="txt_publication_date">Fecha de publicación <span class="input-required">*</span></label>
                                </div>
                                <div class="form-floating col-sm-12 col-md-3">
