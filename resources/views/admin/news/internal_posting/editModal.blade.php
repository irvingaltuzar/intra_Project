      ...
      <div class="modal-content">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-9">
                        <h4><i class="fas fa-edit"></i> Posteo Interno</h4>
                    </div>
            ...
            <div class="card-block">
                <div class="container">
                    <div class="row mt-3" id="data_form_edit">
                        <div class="row mb-2">
                            <input type="hidden" class="form-control" id="internal_posting_id">
                            <div class="row mb-2">
                                ...
                                <div class="form-floating col-sm-12 col-md-3">
                                    <div class="form-multiselect" id="input_sm-select_subgroup_edit">
                                        <label class="lbl-multiselect" for="select_subgroup_edit">Ubicación <span class="input-required">*</span></label>
                                        <div class="d-flex text-left align-items-center w-100">
                                ...
                                <div class="form-floating col-sm-12 col-md-3">
                                    ...
                                    <label for="txt_publication_date_edit">Fecha de publicación <span class="input-required">*</span></label>
                                </div>
                                <div class="form-floating col-sm-12 col-md-3">
