...
@section( 'content')
    ...
    @include('admin.news.policy.addModal')
    @include('admin.news.policy.modalUserList')
    @include('admin.news.policy.viewModal')
    @include('admin.news.policy.editModal')
    @include('admin.news.policy.modalUserListEdit')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/news/policy.js')}}"></script>
