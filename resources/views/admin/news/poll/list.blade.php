...
@section( 'content')
    ...
    @include('admin.news.poll.addModal')
    @include('admin.news.poll.modalUserList')
    @include('admin.news.poll.editModal')
    @include('admin.news.poll.modalUserListEdit')
    @include('admin.news.poll.viewModal')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/news/poll.js')}}"></script>
