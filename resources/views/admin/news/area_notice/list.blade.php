...
@section( 'content')
    ...
    @include('admin.news.area_notice.addModal')
    @include('admin.news.area_notice.modalUserList')
    @include('admin.news.area_notice.viewModal')
    @include('admin.news.area_notice.editModal')
    @include('admin.news.area_notice.modalUserListEdit')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/news/area_notice.js')}}"></script>
