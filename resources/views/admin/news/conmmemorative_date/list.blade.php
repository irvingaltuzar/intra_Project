...
@section( 'content')
    ...
    @include('admin.news.conmmemorative_date.addModal')
    @include('admin.news.conmmemorative_date.viewModal')
    @include('admin.news.conmmemorative_date.editModal')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/news/conmmemorative_date.js')}}"></script>
