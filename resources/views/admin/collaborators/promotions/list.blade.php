...
@section( 'content')
    ...
    @include('admin.collaborators.promotions.addModal')
    @include('admin.collaborators.promotions.viewModal')
    @include('admin.collaborators.promotions.editModal')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/collaborators/promotions.js')}}"></script>
