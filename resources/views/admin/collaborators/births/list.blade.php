...
@section( 'content')
                        ...
                        <div class="row justify-content-end m-2 p-2">
                            <div class="offset-md-2 col-sm-12 col-md-5">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control"  id="txt_search" placeholder="Nacimiento..." aria-label="Username" aria-describedby="basic-addon1">
    ...
    @include('admin.collaborators.births.addModal')
    @include('admin.collaborators.births.viewModal')
    @include('admin.collaborators.births.editModal')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/collaborators/births.js')}}"></script>
