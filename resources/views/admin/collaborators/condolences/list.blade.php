...
@section( 'content')
    ...
    @include('admin.collaborators.condolences.addModal')
    @include('admin.collaborators.condolences.viewModal')
    @include('admin.collaborators.condolences.editModal')
    @include('admin.communiques.modalUserList')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/collaborators/condolences.js')}}"></script>
