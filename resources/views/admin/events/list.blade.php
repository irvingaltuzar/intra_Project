...
@section( 'content')
                    ...
                    <div class="card-block table-border-style">
                        <div class="row justify-content-end m-2 p-2">
                            ...
                            <div class="col-sm-12 col-md-2">
                                <select id="type_event_by" class="form-select" aria-label="Default select example">
    ...
    @include('admin.events.addModal')
    @include('admin.events.viewModal')
    @include('admin.events.editModal')

@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/events/events.js')}}"></script>
    <script src="{{asset('js/generico/pagination_control.js')}}"></script>

    <script>
        ths.general_data.data = @json($list);
        ths.preLoadTypeEvents();
