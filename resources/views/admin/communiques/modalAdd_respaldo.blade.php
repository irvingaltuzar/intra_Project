                    ...
                    <div class="row">
                        <div class="col-md-9">
                            @if($communique_type == 'council')
                                <h4><i class="fas fa-plus"></i> Comunicado Institucional</h4>
                            @elseif($communique_type == 'organizational')
                                <h4><i class="fas fa-plus"></i> Movimiento Organizacional</h4>
                            @elseif($communique_type == 'institutional')
                                <h4><i class="fas fa-plus"></i> Campaña Institucional</h4>
                            @endif
                        </div>
                    ...
                    <div class="container">
                        <div class="row mt-3" id="data_form_add">
                            <div class="row mb-2">
                                <div class="form-floating col-sm-12 col-md-4">
                                    <div class="form-multiselect" id="input_sm-select_location">
                                        ...
                                        <div class="d-flex text-left align-items-center w-100">
                                            <select id="select_location" class="selectpicker form-control" multiple aria-label="Default select example" data-selected-text-format="count" data-live-search="true">
                                            </select>
                                ...
                                <div class="form-floating col-sm-12 col-md-4">
                                    <select class="form-select" aria-label="Default select example" id="select_priority"
                                        required>
                            ...
                            <div class="row mb-2">
                                <div class="form-floating col-sm-12 col-md-12">
                                    <input type="text" class="form-control" id="txt_link" placeholder="Link">
                            ...
                            <div class="modal-footer mt-3">
                                ...
                                <button class="btn btn-primary" onclick="saveCommunique()">Guardar</button>
                            </div>
                        </div>
