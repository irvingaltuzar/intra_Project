...
@section( 'content')
    ...
    @include('admin.benefits.benefits.addModal')
    @include('admin.benefits.benefits.viewModal')
    @include('admin.benefits.benefits.editModal')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/benefits/benefits.js')}}"></script>
