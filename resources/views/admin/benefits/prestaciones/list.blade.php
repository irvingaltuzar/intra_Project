...
@section( 'content')
    ...
    @include('admin.benefits.prestaciones.addModal')
    @include('admin.benefits.prestaciones.viewModal')
    @include('admin.benefits.prestaciones.editModal')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/benefits/prestaciones.js')}}"></script>
