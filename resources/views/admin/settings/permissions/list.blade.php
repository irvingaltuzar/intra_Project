...
@section( 'content')
    ...
    @include('admin.settings.permissions.addModal')
    @include('admin.settings.permissions.viewModal')
    @include('admin.settings.permissions.editModal')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/settings/permission.js')}}"></script>
