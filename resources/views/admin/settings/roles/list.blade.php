...
@section( 'content')
    ...
    @include('admin.settings.roles.addModal')
    @include('admin.settings.roles.viewModal')
    @include('admin.settings.roles.editModal')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/settings/rol.js')}}"></script>
