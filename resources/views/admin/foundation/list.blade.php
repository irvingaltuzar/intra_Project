...
@section( 'content')
    ...
    @include('admin.foundation.addModal')
    @include('admin.news.internal_posting.modalUserList')
    @include('admin.foundation.viewModal')
    @include('admin.foundation.editModal')
    @include('admin.news.internal_posting.modalUserListEdit')
@endsection

@section('script_footer')
    <script type="text/javascript" src="{{asset('js/admin/foundation/foundation_capsule.js')}}"></script>
