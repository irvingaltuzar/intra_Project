      ...
      <div class="modal-content">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-9">
                        <h4><i class="fas fa-eye"></i> Capacitación</h4>
                    </div>
                    ...
                    <div class="row mt-3" id="form_add">
                        ...
                        <div class="row mb-2">
                            <div class="form-floating col-sm-12 col-md-6">
                                <input type="date" class="form-control" id="txt_date_start_view"
                                    placeholder="Fecha de inicio" required disabled>
                                <label for="txt_date_start_view">Fecha de inicio <span
                                        class="input-required">*</span></label>
                            </div>
                            <div class="form-floating col-sm-12 col-md-6">
                                <input type="time" class="form-control" id="txt_time_start_view"
                                    placeholder="Hora de inicio" required disabled>
                                <label for="txt_time_start_view">Hora de inicio <span
                                    class="input-required">*</span></label>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="form-floating col-sm-12 col-md-12">
                                <input type="text" class="form-control" id="txt_place_view" rows="3" maxlength="254"
                                    placeholder="Lugar de la capacitación" disabled>
                                <label for="txt_place_view">Lugar de la capacitación <span
                                    class="input-required">*</span></label>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row mb-2">
                            <div class="form-floating col-sm-12 col-md-12">
                                <input type="text" class="form-control" id="txt_link_view" maxlength="254"
