      ...
      <div class="modal-content">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-9">
                        <h4><i class="fas fa-edit"></i> Capacitación</h4>
                    </div>
            ...
            <div class="card-block">
                <div class="container">
                    <div class="row mt-3" id="data_form_edit">
                        <div class="row mb-2">
                            <input type="hidden" class="form-control" id="training_id">
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                <div class="form-floating col-sm-12 col-md-6">
                                    <input type="date" class="form-control" id="txt_date_start_edit"
                                        placeholder="Fecha de inicio" required >
                                    <label for="txt_date_start_edit">Fecha de inicio <span
                                            class="input-required">*</span></label>
                                </div>
                                <div class="form-floating col-sm-12 col-md-6">
                                    <input type="time" class="form-control" id="txt_time_start_edit"
                                        placeholder="Hora de inicio" required >
                                    <label for="txt_time_start_edit">Hora de inicio <span
                                        class="input-required">*</span></label>
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                <div class="form-floating col-sm-12 col-md-12">
                                    <input type="text" class="form-control" id="txt_link_edit" maxlength="254"
                                        placeholder="Link">
