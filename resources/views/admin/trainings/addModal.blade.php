        ...
        <div class="modal-content">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-9">
                            <h4><i class="fas fa-plus"></i> Capacitación</h4>
                        </div>
                        ...
                        <div class="row mt-3" id="data_form_add">
                            ...
                            <div class="row mb-2">
                                <div class="form-floating col-sm-12 col-md-6">
                                    <input type="date" class="form-control" id="txt_date_start"
                                        placeholder="Fecha de inicio" required>
                                    <label for="txt_date_start">Fecha de inicio <span
                                            class="input-required">*</span></label>
                                </div>
                                <div class="form-floating col-sm-12 col-md-6">
                                    <input type="time" class="form-control" id="txt_time_start"
                                        placeholder="Hora de inicio" required>
                                    <label for="txt_time_start">Hora de inicio <span
                                        class="input-required">*</span></label>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="form-floating col-sm-12 col-md-12">
                                    ...
                                    <label for="txt_place">Lugar de la capacitación <span
                                        class="input-required">*</span></label>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="form-floating col-sm-12 col-md-12">
                                    <input type="text" class="form-control" id="txt_link" maxlength="254"
                                        placeholder="Link">
                            ...
                            <div class="row mb-2 mt-2">
                                <div class="col-sm-12 col-md-12">
                                    <div class="input-file" id="input-file_file_photo">
                                        ...
                                        <input class="form-control d-none" type="file" accept="image/png,image/jpeg,image/jpg"
