...
function saveRecord(){
    ...
    if(isValid == true){
        ...
        axios.post('/admin/news/conmmemorative_date-save',formData,config)
        .then(response =>{
...
function editRecord(_id){
    ...
    document.querySelector("#conmmemorative_date_id").value= element.id;
...
function updateRecord(){
    ...
    if(isValid == true){
        ...
        formData.append('conmmemorative_date', document.querySelector('#conmmemorative_date_id').value);
        ...
        axios.post('/admin/news/conmmemorative_date-edit',formData,config)
        .then(response =>{
...
function deleteRecord(_id){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios.get('/admin/news/conmmemorative_date-delete/'+_id)
            .then(response =>{
                let resp = response.data;
                if(resp.success == 1){
                    ths.getPage(1);
