...
function showList(val) {
    ...
    .then(response =>{
        ...
        val == 0 ? $('#modal_user_list_policy').modal('show') : $('#modal_user_list_policy_edit').modal('show')
    })
    .catch(error =>{
...
function saveRecord(){
    ...
    if(isValid == true){
        ...
        let cont_files=0;
        document.querySelectorAll(".policy_files").forEach((temp_input,key) =>{
        ...
        axios.post('/admin/news/policy-save',formData,config)
        .then(response =>{
...
function editRecord(_id){
    ...
    document.querySelector("#policy_id").value= element.id;
...
async function updateRecord(){
    ...
    if(isValid == true){
        ...
        formData.append('policy', document.querySelector('#policy_id').value);
        ...
        await axios.post('/admin/news/policy-edit',formData,config)
        .then(response =>{
...
function deleteRecord(_id){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios.get('/admin/news/policy-delete/'+_id)
            .then(response =>{
                let resp = response.data;
                if(resp.success == 1){
                    ths.getPage(1);
    ...
    let row_HTML = `
        <div class="col-md-12 mb-3" id="div_file_${element_id}">
            <div class="input-file" id="input-file_${element_id}">
                ...
                <input class="form-control d-none policy_files" type="file" accept="application/.xls,.doc,.xlsx,.docx,.pdf" id="${element_id}" placeholder="Imagen" onchange="uploadDocument(this)" required>
            </div>
        </div>
    `;
...
function deleteUploadedDoc(_event){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios.get(`/admin/news/policy-delete-file/${file_id}/${record_id}`)
            .then(response =>{
                let resp = response.data;
                if(resp.success == 1){
                    ths.getPage(1);
